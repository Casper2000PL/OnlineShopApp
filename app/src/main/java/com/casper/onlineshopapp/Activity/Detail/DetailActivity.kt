...
import com.casper.onlineshopapp.Domain.ModelSelector
import com.casper.onlineshopapp.Helper.ManagmentCart
...
class DetailActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Fix: Handle nullable return from getParcelableExtra
        item = intent.getParcelableExtra<ItemsModel>("object") ?: run {
            finish() // Close activity if no item was passed
            return
        }
